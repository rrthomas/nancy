...
\begin{verbatim}
nancy.pl [OPTIONS] SOURCES DESTINATION TEMPLATE [BRANCH]
\end{verbatim}
...
\item For each leaf directory (that is, a directory that contains only files) of the list of source directories, start from that directory.
