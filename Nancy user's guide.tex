...
% New commands
\renewcommand{\copyrightyear}{2002--2012}
...
\SaveVerb{webroot}|NANCY_FILE_ROOT|
\item[\UseVerb{webroot}]the root directory of the site
...
\begin{enumerate}
\item Replace the \verb|NANCY_WEB_ROOT| prefix of the URL by \verb|NANCY_FILE_ROOT| and look up the path in the sources.
...
\begin{enumerate}
\item For each subdirectory of  \verb|NANCY_FILE_ROOT|, in right-to-left order, prepend it to the path.
