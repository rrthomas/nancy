...
\\User’s guide}
\date{12th March 2016} % FIXME: have this date automatically filled in by git
...
Nancy is written in Perl, and requires version 5.10 or later, and the \verb|RRT::Macro| module version 2 or later (available from \url{https://github.com/rrthomas/perl}.
