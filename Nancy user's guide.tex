...
\item Find all the \verb|href| links in the page, and add them to the list.
...
\item Process the rest of the pages in the list, skipping any that have already been processed, until the list is empty.
\end{enumerate}
