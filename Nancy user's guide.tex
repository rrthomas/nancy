...
\\User’s guide}
\date{2nd April 2016\\\copyright\ 2002--2016} % FIXME: have this date automatically filled in by git
...
Nancy is written in Perl, and requires version 5.10 or later, the \verb|File::Slurp| module, and the \verb|RRT| modules (available from \url{https://github.com/rrthomas/perl}.
